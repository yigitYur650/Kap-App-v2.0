...
var turkishBaselinePrices = map[string]ItemPriceEstimate{
	...
	"kepek":       {ItemName: "Kepek Ekmeği", EstimatedPrice: 22.50, MinPrice: 18.0, MaxPrice: 28.0, Category: "Unlu Mamul", UnitSpec: "400g Paket", SourceMarket: "Migros", Brand: "Uno"},
	...
	"tereyağ":     {ItemName: "Tereyağı", EstimatedPrice: 245.00, MinPrice: 210.0, MaxPrice: 290.0, Category: "Kahvaltılık", UnitSpec: "500g Paket", SourceMarket: "Migros / BİM", Brand: "Kebir / Sütaş"},
	...
	"bulgur":      {ItemName: "Bulgur", EstimatedPrice: 38.00, MinPrice: 30.0, MaxPrice: 48.0, Category: "Temel Gıda", UnitSpec: "1 kg Pilavlık", SourceMarket: "Migros / BİM", Brand: "Duru"},
	"kıvırcık":    {ItemName: "Kıvırcık Marul", EstimatedPrice: 35.00, MinPrice: 25.0, MaxPrice: 45.0, Category: "Sebze & Meyve", UnitSpec: "1 Adet Taze", SourceMarket: "Migros", Brand: "Taze Manav"},
	"marul":       {ItemName: "Kıvırcık Marul", EstimatedPrice: 35.00, MinPrice: 25.0, MaxPrice: 45.0, Category: "Sebze & Meyve", UnitSpec: "1 Adet Taze", SourceMarket: "Migros", Brand: "Taze Manav"},
	"fındık":      {ItemName: "Kavrulmuş Fındık", EstimatedPrice: 185.00, MinPrice: 150.0, MaxPrice: 220.0, Category: "Kuruyemiş", UnitSpec: "500g Paket", SourceMarket: "A101 / BİM", Brand: "Tariş"},
	"mercimek":    {ItemName: "Kırmızı Mercimek", EstimatedPrice: 42.50, MinPrice: 35.0, MaxPrice: 55.0, Category: "Temel Gıda", UnitSpec: "1 kg Paket", SourceMarket: "BİM", Brand: "Saban"},
	"brokoli":     {ItemName: "Brokoli", EstimatedPrice: 45.00, MinPrice: 35.0, MaxPrice: 60.0, Category: "Sebze & Meyve", UnitSpec: "1 kg Taze", SourceMarket: "Migros", Brand: "Taze Manav"},
	"domates":     {ItemName: "Domates", EstimatedPrice: 35.00, MinPrice: 25.0, MaxPrice: 45.0, Category: "Sebze & Meyve", UnitSpec: "1 kg Tarla", SourceMarket: "Migros", Brand: "Manav"},
	"salatalık":   {ItemName: "Salatalık", EstimatedPrice: 32.50, MinPrice: 25.0, MaxPrice: 42.0, Category: "Sebze & Meyve", UnitSpec: "1 kg Çengelköy", SourceMarket: "Migros", Brand: "Manav"},
	"patates":     {ItemName: "Patates", EstimatedPrice: 22.50, MinPrice: 15.0, MaxPrice: 30.0, Category: "Sebze & Meyve", UnitSpec: "1 kg File", SourceMarket: "BİM", Brand: "Manav"},
	"soğan":       {ItemName: "Kuru Soğan", EstimatedPrice: 18.50, MinPrice: 12.0, MaxPrice: 25.0, Category: "Sebze & Meyve", UnitSpec: "1 kg File", SourceMarket: "BİM", Brand: "Manav"},
	"zeytin":      {ItemName: "Siyah Zeytin", EstimatedPrice: 165.00, MinPrice: 130.0, MaxPrice: 210.0, Category: "Kahvaltılık", UnitSpec: "500g Sele", SourceMarket: "Migros", Brand: "Marmarabirlik"},
}
...
func (s *AIService) EstimatePrices(items []ItemSpecDTO) (*PriceEstimationResult, error) {
	...
	// Stage 1: Primary Source — Playwright Live Targeted Web Scraper (Serial 1-Worker for Render CPU Dedication)
	if s.marketPriceSvc != nil {
		var wg sync.WaitGroup
		var mu sync.Mutex
		sem := make(chan struct{}, 1) // 1 worker gives 100% CPU to Chromium on Render free tier
